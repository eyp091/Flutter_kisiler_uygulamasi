...
class _AnasayfaState extends State<Anasayfa> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //FutureBuilder, 'Future' nesnesi kullanarak gelecekteki bir değeri bekler ve bu değer geldiğinde UI'yi güncellemek için kullanılır.
      body: BlocBuilder<AnasayfaCubit, List<Kisiler>>(
        builder: (context, kisilerListesi){
          if(kisilerListesi.isNotEmpty){
            return ListView.builder(
              itemCount: kisilerListesi.length,
              itemBuilder: (context, indeks){//Kişi sayısı kadar çalışacak.
                var kisi = kisilerListesi[indeks];
                //Card tasarımı yapıcaz
